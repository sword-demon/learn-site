      ...
      <section class="auth-form-section">
        ...
        <p class="auth-switch">
          ...
          <el-button
            ...
            @click="switchMode"
            >{{ copy.switchLabel }}</el-button
          >
        </p>
        <nav class="auth-legal" aria-label="服务条款">
...
.auth-form :deep(.el-input__wrapper.is-focus) {
  box-shadow:
    0 0 0 1px var(--seal) inset,
    0 0 0 3px var(--seal-soft);
}
