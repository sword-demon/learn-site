...
import type { CourseStatus, CourseTreeDTO, LessonContentType, PriceMode } from '@learn-site/contracts'
...
const tree = reactive<Partial<CourseTreeDTO> & { chapters: NonNullable<CourseTreeDTO['chapters']> }>({
  id: 0,
  title: '',
  cover_url: null,
  teacher_name: '',
